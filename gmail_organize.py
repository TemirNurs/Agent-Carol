...
Source of truth: CRM-Bid-Log.xlsx (April 29, 2026 snapshot, 22 LOST + 25 ACTIVE).
...
EMAIL = "estimates@carolinacommercialfinishes.com"
...
LOST_RULES = [
    ("Lost", 'subject:0473', "BID-0014 Food Lion #0473"),
    ("Lost", 'subject:1044', "BID-0015 Food Lion #1044"),
    ("Lost", 'subject:0133', "BID-0016 Food Lion #0133"),
    ("Lost", 'subject:1513', "BID-0023 Food Lion #1513"),
    ("Lost", 'subject:0387', "BID-0024 Food Lion #0387"),
    ("Lost", 'subject:1510', "BID-0025 Food Lion #1510"),
    ("Lost", 'subject:1353', "BID-0026 Food Lion #1353"),
    ("Lost", 'subject:1290', "BID-0036 Food Lion #1290"),
    ("Lost", 'subject:1360', "BID-0037 Food Lion #1360"),
    ("Lost", 'subject:1359', "BID-0033/0034 Food Lion #1359A"),
    ("Lost", 'subject:0593', "BID-0039 Food Lion #0593"),
    ("Lost", 'subject:"Whole Foods"', "BID-0028/0029 Whole Foods"),
    ("Lost", 'subject:"Rural King"', "BID-0030 Rural King Greensboro"),
    ("Lost", 'subject:Mebane OR subject:"MOB II" OR subject:"Duke Health"', "BID-0031 Duke Mebane MOB II"),
    ("Lost", 'subject:OCTech OR subject:Orangeburg', "BID-0032 OCTech Health Science"),
    ("Lost", 'subject:TPA OR subject:"Flex Buildings"', "BID-0035 TPA Flex Buildings"),
    ("Lost", 'subject:Nissan', "BID-0043 Nissan Dealership"),
    ("Lost", 'subject:Denham', "BID-0045 Target Denham Springs"),
    ("Lost", 'subject:Lincolnton', "BID-0046 Target Lincolnton"),
    ("Lost", 'subject:"Target Winston"', "BID-0047 Target Winston-Salem"),
]
...
INTERNAL_RULES = [
    # Per user (May 5, 2026): Internal label is ONLY for emails from Sviatlana or Sergey.
...
def main():
    ...
    # Ensure all labels exist (CRM-derived + category catch-alls)
    for lbl in ["Bid Invites", "Won", "On Hold", "Known GC", "Pending Review",
                "Vendors", "Financial", "Personal", "Travel",
