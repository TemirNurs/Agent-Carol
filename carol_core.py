...
# Owner info
OWNER_NUMBER = os.environ.get("OWNER_PHONE", "")
OWNER_EMAIL = os.environ.get("OWNER_PERSONAL_EMAIL", "")
CCF_EMAIL = os.environ.get("GMAIL_USER", "estimates@carolinacommercialfinishes.com")
