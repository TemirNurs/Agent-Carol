...
def test_cc_internal_includes_team():
    """CC list MUST include cs + Sviatlana + Sergei. AGENTS_LESSONS.md R4."""
    assert "cs@carolinacommercialfinishes.com" in CC_INTERNAL
    assert "wilsonsviatlana83@gmail.com" in CC_INTERNAL
    assert "smayurov@gmail.com" in CC_INTERNAL
