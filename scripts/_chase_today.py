...
CC Sviatlana + Sergei. Logs each send to chase state + bid_status history.
"""
...
def has_replied_recently(email, days=14):
    ...
    Critical: chase_today must respect prior intelligence. If Tanya replied
    on 5/11 saying 'project awarded to Horizon, contact Tyler', we MUST NOT
    re-chase her on 5/21 with another generic status-check. The 'fuck them
