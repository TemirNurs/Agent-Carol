...
Cinthia at Parkway has 2 Hyatts pending, she got 2 separate FU emails 25 min
apart. If Tanner at Farris has 4 Food Lions, he got 4 separate emails. That
...
def main():
    ...
    for key, info in state.items():
        ...
        # bid's first nudge (the Midtown East $307K bug).
