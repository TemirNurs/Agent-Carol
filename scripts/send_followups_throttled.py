...
--interval seconds (default 1200 = 20 min) with Sviatlana + Sergei CC'd.
...
CC_INTERNAL = "cs@carolinacommercialfinishes.com,wilsonsviatlana83@gmail.com,smayurov@gmail.com"  # cs@ + Sviatlana + Sergei
