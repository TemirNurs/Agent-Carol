...
Usage:
  ...
  python scripts/team_chat_audit.py --who 1380687865   # one user's transcript
...
KNOWN = {
    "":  ("Nursultan", "owner — full audit access"),
    "1380687865": ("Sviatlana", "CCF accountant"),
    # Sergey's ID will appear here once he messages Carol
}
