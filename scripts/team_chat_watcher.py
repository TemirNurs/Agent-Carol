...
Polls the OpenClaw session files every cycle and sends Nursultan a Telegram ping
...
Owner (Nursultan, ID 627961088) is the recipient of the alerts. We do NOT
alert on Nursultan's own Telegram messages — only on teammates (Sviatlana,
Sergey, or any new sender).
