...
Output (Telegram message):
  📊 CCF Status — May 4
  49 bids tracked · $4.0M total bid value

  • Lost: 25 ($2.12M)
  • Awaiting Decision: 12 ($1.37M)
  • Bid Submitted: 11 ($492K)
  • Won: 1 ($21.8K bid / $18K signed)

  Today's activity:
  • +3 → Lost (BID-0018, BID-0024, BID-0026)
  • +2 → Awaiting (from On Hold reclassification)
  • 24 follow-ups sent
  • 5 GC replies processed

  Active pipeline: $1.86M still in play
