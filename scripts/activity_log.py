...
Usage from Python:
  ...
  log_event(internal_id="abc-uuid", bid_id="BID-0042", project="Sample Project",
            type="follow_up", direction="outbound",
            counterparty="estimator@examplegc.com (GC Estimator)",
            channel="email",
...
CLI:
  python scripts/activity_log.py --bid BID-0042 \
    --type follow_up --direction outbound --counterparty "estimator@examplegc.com" \
