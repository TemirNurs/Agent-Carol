...
7. **COMPARE TO HISTORY.** When presenting an estimate, compare to similar past projects: "This is $0.15/SF higher than our last grocery remodel bid"
...
```bash
# GC knowledge
python skills/ccf-estimator/scripts/memory_store.py gc get --name "Example GC"
python skills/ccf-estimator/scripts/memory_store.py gc update --name "Example GC" --relationship existing --last-feedback "Competitive on retail TI"
python skills/ccf-estimator/scripts/memory_store.py gc record-bid --name "Example GC" --project "Sample Retail TI" --bid 25000 --result won
python skills/ccf-estimator/scripts/memory_store.py gc list

# Facility type patterns
python skills/ccf-estimator/scripts/memory_store.py facility get --type retail_grocery
python skills/ccf-estimator/scripts/memory_store.py facility learn --type retail_grocery --sf 22000 --bid 25000 --hours 331
python skills/ccf-estimator/scripts/memory_store.py facility list

# Bid history
python skills/ccf-estimator/scripts/memory_store.py history add --project "Sample Retail TI" --gc "Example GC" --bid 25000 --type retail_grocery
python skills/ccf-estimator/scripts/memory_store.py history update --project "Sample Retail TI" --result won --feedback "GC said competitive"
...
```bash
python skills/ccf-estimator/scripts/project_store.py create --name "Sample Retail TI" --gc "Example GC" --tier target --due "2026-03-18"
python skills/ccf-estimator/scripts/project_store.py list
python skills/ccf-estimator/scripts/project_store.py save-phase --id sample-retail-ti --phase sow --content "..."
```
...
6. **Compare to historical bids** for same facility type:
   ...
   - "This bid is $1.17/SF — our average for grocery remodels is $0.95/SF. That's 23% higher. Consider reviewing prod rates."
...
Common material costs per SF (from grocery remodel estimates):
